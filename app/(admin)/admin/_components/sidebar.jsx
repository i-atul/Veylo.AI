...
import { LayoutDashboard,  Calendar, Cog, LogOut, CarFront, ChartNoAxesCombined as Charts } from "lucide-react";
					...
					{routes.map((route) => (
						<Link
							...
							className={cn(
								...
								pathname === route.href
									? "text-cyan-700 bg-blue-100/50 hover:bg-blue-100 hover:text-cyan-700"
									: "",
								"h-12"
							)}
						>
